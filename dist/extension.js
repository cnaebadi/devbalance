...
function activate(context) {
    ...
    workDuration = (config.get('workDurationMinutes') || 30) * 60 * 1000;
    breakDuration = (config.get('breakDurationMinutes') || 5) * 60 * 1000;
    ...
    reportButton.show();
    context.subscriptions.push(statusBarItem, pauseButton, resumeButton, resetButton, reportButton, vscode.commands.registerCommand('devBalance.pauseTimer', pauseTimer), vscode.commands.registerCommand('devBalance.resumeTimer', resumeTimer), vscode.commands.registerCommand('devBalance.resetTimer', resetTimer), vscode.commands.registerCommand('devBalance.showDailyReport', showDailyReport), vscode.commands.registerCommand('devBalance.showMonthlyReport', showMonthlyReport), vscode.commands.registerCommand('devBalance.showYearlyReport', showYearlyReport), vscode.commands.registerCommand('devBalance.selectReport', selectReport), vscode.commands.registerCommand('devBalance.clearLogs', () => clearAllLogs(context)), vscode.commands.registerCommand('devBalance.showLogs', () => {
    ...
    vscode.workspace.onDidChangeConfiguration(e => {
        if (e.affectsConfiguration('devBalance.workDurationMinutes') ||
...
function updateStatusBar(seconds, isWorking) {
...
function showMonthlyReport() {
    ...
    for (const date in logs) {
        if (date.startsWith(currentMonth)) {
            ...
            totalBreakSeconds += (((_a = log.minuteBreaks) === null || _a === void 0 ? void 0 : _a.reduce((a, b) => a + b, 0)) || 0);
        }
    }
...
function showChartReport(mode) {
    ...
    if (mode === 'daily') {
        ...
        for (let i = 0; i < 24; i++) {
            const codingMinutes = Math.floor((((_a = log.hourlySeconds) === null || _a === void 0 ? void 0 : _a[i]) || 0) / 60);
            const breakMinutes = Math.floor((((_b = log.hourlyBreaks) === null || _b === void 0 ? void 0 : _b[i]) || 0) / 60);
            labels.push(i.toString().padStart(2, '0'));
            coding.push(parseFloat(((((_c = log === null || log === void 0 ? void 0 : log.hourlySeconds) === null || _c === void 0 ? void 0 : _c[i]) || 0) / 60).toFixed(1)));
    ...
    if (mode === 'monthly') {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            const breakSeconds = ((_d = log === null || log === void 0 ? void 0 : log.minuteBreaks) === null || _d === void 0 ? void 0 : _d.reduce((a, b) => a + b, 0)) || 0;
    ...
    if (mode === 'yearly') {
        ...
        for (const date in logs) {
            if (date.startsWith(year)) {
                ...
                monthlyCodingSeconds[month] += (log === null || log === void 0 ? void 0 : log.codingSeconds) || 0;
                const breakSeconds = ((_e = log === null || log === void 0 ? void 0 : log.minuteBreaks) === null || _e === void 0 ? void 0 : _e.reduce((a, b) => a + b, 0)) || 0;
